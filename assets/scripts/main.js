...
function initFormHandler() {
  ...
  submitButton.addEventListener("click", (event) => {
    ...
    let recipeObject = {};
    recipeObject = JSON.parse(FormData);  // FIXME: notsure about this part
    ...
    let localArr = localStorage.getItem("recipes");
    localArr.push(FormData);
  })



  // B10. TODO - Get a reference to the "Clear Local Storage" button
  let clearButton = document.querySelector("[type='button']");
